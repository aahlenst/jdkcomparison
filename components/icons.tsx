...
export function XMarkIcon(props: PropsWithChildren<IconProps>) {
...
export function InfoIcon(props: PropsWithChildren<IconProps>) {
...
export function SquarePlusIcon(props: PropsWithChildren<IconProps>) {
...
export function SquareMinusIcon(props: PropsWithChildren<IconProps>) {
...
export function CircleIcon(props: PropsWithChildren<IconProps>) {
...
export function CircleHalfStrokeIcon(props: PropsWithChildren<IconProps>) {
...
export function MinusIcon(props: PropsWithChildren<IconProps>) {
...
export function QuestionIcon(props: PropsWithChildren<IconProps>) {
...
export function BarsIcon(props: PropsWithChildren<IconProps>) {
	// Font Awesome Free v6, CC BY 4.0, solid/bars.svg
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
			{props.children}
...
export function GitHubIcon(props: PropsWithChildren<IconProps>) {
	// Font Awesome Free v6, CC BY 4.0, brands/github.svg
	return (
...
export function EnvelopeIcon(props: PropsWithChildren<IconProps>) {
	// Font Awesome Free v6, CC BY 4.0, regular/envelope.svg
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
			{props.children}
...
export function LinkIcon(props: PropsWithChildren<IconProps>) {
	// Font Awesome Free v6, CC BY 4.0, solid/link.svg
	return (

	...
	const innerElements = (
		<>
			<a
				...
				href={`#${generatedSlug}`}
			>
				<div className="w-6 h-6 text-red-600 ring-1 ring-red-900/5 rounded-md shadow-xs flex items-center justify-center hover:ring-red-900/10 hover:shadow-sm hover:text-red-700">

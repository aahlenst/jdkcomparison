	...
	return (
		<Popover>
			...
			<ClientOnlyPortal selector="#comparison-modals">
				...
				<Popover.Overlay
					className="mobile-feature-explanation-overlay sm:hidden fixed z-40 inset-0 bg-black opacity-30"/>
				{/* Popover for smaller screens. Appears at the bottom of the screen. */}
				<Popover.Panel
					className="mobile-feature-explanation sm:hidden fixed z-40 bottom-0 inset-x-0"
				>
					<div

...
-   Watch whether you receive updates promptly and whether the quality is acceptable.
-   If you require specific functionality (for example, a garbage collector) on an older JDK, ask the vendor whether
    they maintain that functionality and apply at least backports to it. Areas notorious for widely varying levels of
    support are garbage collectors, platform support (especially anything beyond x86, 64-bit, and ARM, 64-bit), and
